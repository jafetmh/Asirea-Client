<template>
    <div class="dialog-container">
        <dialog class="modal rounded" ref="dialog">
            <div class="content">
                <Vue3Lottie :animation-data="props.icon" :height="100" :width="100" :loop="false" style="margin-top: -15px;"></Vue3Lottie>
                <div class="ms-2">
                    <h6>{{ props.header }}</h6>
                    <p>{{ props.message }}</p>
                </div>
            ...
            <div class="dlg-buttons">
                <button class="rounded" @click="closeModal">cerrar</button>
            </div>
        </dialog>
    </div>
</template>
...
.dialog-container {
    ...
    .modal[open] {
        ...
        box-shadow: 0 0 25px rgba(var(--black-rgb), 1);
        .dlg-buttons {
            width: 100%;
